...
SET FOREIGN_KEY_CHECKS = 0; # desactivación temporal llave foránea por tenerla en cascade
...
SET FOREIGN_KEY_CHECKS = 1; # la volvemos a activar
...
# Eliminar un registro concreto de la tabla credit card
SET FOREIGN_KEY_CHECKS = 0; # desactivación temporal llave foránea por tenerla en cascade
